...
impl Page for HomePage {
    fn draw_page(&self) -> Result<()> {
        ...
        epics.iter().sorted_by_key(|(id, _)| *id).for_each(|(id, epic)| {
            print!("{}|", get_column_string(&id.to_string(), 12));
            print!("{}|", get_column_string(&epic.name, 34));
            print!("{}", get_column_string(&epic.status.to_string(), 18));
        });
...
impl Page for EpicDetail {
    fn draw_page(&self) -> Result<()> {
        ...
        print!("{}|", get_column_string(&self.epic_id.to_string(), 6));
        print!("{}|", get_column_string(&epic.name, 14));
        print!("{}|", get_column_string(&epic.description, 29));
        print!("{}", get_column_string(&epic.status.to_string(), 14));
        ...
        stories.iter().sorted_by_key(|(id, _)| *id).for_each(|(id, story)| {
            print!("{}|", get_column_string(&id.to_string(), 12));
            print!("{}|", get_column_string(&story.name, 34));
            print!("{}", get_column_string(&story.status.to_string(), 18));
        });
